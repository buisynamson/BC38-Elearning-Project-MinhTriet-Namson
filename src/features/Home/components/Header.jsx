    ...
    if (localStorage.getItem("TOKEN") === null) {
      return (
        <div className="flex w-40 items-center">
          ...
          <NavLink
            className="font-semibold text-white text-lg no-underline"
            to="/signup"
          >
            Sign up
          </NavLink>
      ...
      return (
        ...
        <div>
          <Dropdown
            ...
            placement="bottom"
          >
            <Button type="ghost" className="text-white font-semibold text-base">Hello,<span className="text-yellow-300"> {userSignin?.hoTen || userLogged?.hoTen}</span></Button>
          </Dropdown>
          {userSignin?.maLoaiNguoiDung === "GV" && <Button type="primary" onClickCapture={()=>navigate('/admin')}>Quản lý</Button>}
        </div>
      );
    }
  };
  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div
          className={`${showNav} w-full md:block md:w-auto`}
          id="navbar-default"
        >
          <ul className="list-none  font-medium flex flex-col items-center p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <li>
              <NavLink className="block no-underline py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">
                Về chúng tôi
              </NavLink>
            </li>
            <li>
